			...
			<Form>
				...
				<Form.Group>
					...
					<Form.Control as="select" value={level} onChange={(e) => setLevel(e.target.value)}>
						...
						{new Array(10).fill(0).map((_, i) => <option key={i} value={i}>{i === 0 ? 'Cantrip' : i}</option>)}
					</Form.Control>
				</Form.Group>
				<Form.Group>
				...
				<Form.Group>
					...
					<Form.Control as="select" value={concentration} onChange={(e) => setConcentration(e.target.value)}>
						<option value="any">Any</option>
				...
				<Form.Group>
					...
					<Form.Control as="select" value={classes} onChange={(e) => setClasses(e.target.value)}>
						<option value="any">Any</option>
